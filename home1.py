...
rp=photo.resize((my_image_width, my_image_height), Image.LANCZOS)
my_image = ImageTk.PhotoImage(rp)

my_label = Label(image=my_image)
my_label.pack(fill='y')

frame = Frame(root, width=230, height=800, bg="white")
frame.place(x=0,y=0)
...
btn = Button(frame, text="Change Profile", fg='black', font=8, bg='orange1', border=2)
btn.place(x=38,y=190)

# f=font.Font(size=14)

# for Label service in a frame
btn1 = Label(frame, text="Service", fg="black", bg="white", font="comicsansns 15 bold", border=0)
btn1.place(x=70, y=260)


#for Label profile in a frame
btn2 = Label(frame, text="Profile", fg="black", bg="white", font="comicsansns 15 bold", border=0)
btn2.place(x=70, y=310)

#for Label upload bike in a frame
btn3 = Label(frame, text="Upload Bike", fg="black", bg="white", font="comicsansns 15 bold", border=0)
btn3.place(x=70, y=360)

# for Label Contact in a frame
btn4 = Label(frame, text="Contact", fg="black", bg="white", font="comicsansns 15 bold", border=0)
btn4.place(x=70, y=410)

#for Label Setting in a frame
btn5 = Label(frame, text="Setting", fg="black", bg="white", font="comicsansns 15 bold", border=0)
btn5.place(x=70, y=460)

#for Label Logout in a frame
btn6 = Label(frame, text="logout", fg="black", bg="white", font="comicsansns 15 bold", border=0)
...
ser_label = Label(frame, text="service", bg="white", image=serImage)
...
profile_label = Label(frame, text="profile", bg="white", image=profileImage)
...
bike_label = Label(frame, text="bike", bg="white", image=bikeImage)
...
con_label = Label(frame, text="contact", bg="white", image=conImage)
...
set_label = Label(frame, text="setting", bg="white", image=setImage)
...
log_label = Label(frame, text="logout", bg="white", image=logImage)
...
insta_label = Label(root, text="insta", bg="white", image=instaImage)
insta_label.image = instaImage
insta_label.place(x=1480,y=8)
...
# google_label = Label(root, text="google", bg="white", image=googleImage)
...
facebook_label = Label(root, text="facebook", bg="white", image=facebookImage)
facebook_label.image = facebookImage
facebook_label.place(x=1440,y=8)
...
twitter_label = Label(root, text="twitter", bg="white", image=twitterImage)
twitter_label.image = twitterImage
twitter_label.place(x=1400,y=8)

# for home
label = Label(root, text="Home", bg="white", fg="black", font="comicsansns 15 bold")
label.place(x=280, y=9)
...
home_label = Label(root, text="home", bg="orange1", fg="orange1", image=homeImage)
home_label.image = homeImage
home_label.place(x=240,y=8)

#for search
search = Text(root, width=60, height=2)
search.place(x=370, y=8)
...
search_label = Label(root, text="search", bg="white", image=searchImage)
search_label.image = searchImage
search_label.place(x=865,y=8)
...
btn_t1 = Label(root, text="Transaction 1", bg="white", fg="black", width=12, font="comicsansns 15 bold", border=0)
btn_t1.place(x=400, y=260)

#btn for your uploaded bike
btn_bike = Label(root, text="Your Uploaded Bike", bg="white", fg="black",width=15, font="comicsansns 15 bold", border=0)
btn_bike.place(x=600, y=260)

#btn for transaction 2
btn_t2 = Label(root, text="Transaction 2", bg="white", fg="black",width=12, font="comicsansns 15 bold", border=0)
...
money1_label = Label(root, text="money1", bg="white", image=money1Image)
